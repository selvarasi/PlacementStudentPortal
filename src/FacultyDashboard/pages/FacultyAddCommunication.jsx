...
const FacultyAddAptitude = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/api/communication-questions", {
        question,
        options,
        correctAnswer,
        time
  ...
  return (
    <div className="faculty-add-aptitude">
      <h1>Add Communication Question</h1>
...
export default FacultyAddAptitude;
