                ...
                <div className={styles.signup_form_container}>
                    ...
                    <div className={styles.right}>
                        <form className={styles.form_container} onSubmit={handleSubmit}>
                            ...
                            <input type="text" placeholder="Skills (comma separated)" name="Skills" onChange={handleChange} value={data.Skills} required className={styles.input} />
                            
                            {/* Role Selection */}
                            <label>Select Role:</label>
                            <select name="role" onChange={handleChange} className={styles.input}>
